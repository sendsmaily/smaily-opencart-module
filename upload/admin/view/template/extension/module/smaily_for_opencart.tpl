...
<div id="content">
  ...
  <link rel="stylesheet" type="text/css" href="view/stylesheet/smailyforopencart/smaily_admin.css"/>

	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-smaily_for_opencart" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary">
					<i class="fa fa-save"></i>
				</button>
				<a href="<?php echo $cancel_url; ?>" data-toggle="tooltip" title="<?php echo button_cancel; ?>" class="btn btn-default">
                  ...
                  <table class="table table-bordered">
                    <tbody>
                      <?php foreach ($abandoned_cart['products'] as $product): ?>
                        <tr>
                          <td width="70%"><a href="<?php echo $abandoned_cart_table_product_base_url . $product['product_id']; ?>" target="_blank" rel="noopener"><?php echo $product['name']; ?></a></td>
